...
git clone --depth 1 --branch v11.10.0 https://github.com/mattermost/mattermost.git
...
cd mattermost
git apply ../mattermost-oidc/patches/mattermost-v11.10.0.patch
...
```bash
docker build -t your-registry/mattermost-oidc:11.10.0 .
docker push your-registry/mattermost-oidc:11.10.0
```
