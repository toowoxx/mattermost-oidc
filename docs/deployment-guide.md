...
git clone --depth 1 --branch v11.6.6 https://github.com/mattermost/mattermost.git
...
cd mattermost
git apply ../mattermost-oidc/patches/mattermost-v11.6.6.patch
...
```bash
docker build -t your-registry/mattermost-oidc:11.6.6 .
docker push your-registry/mattermost-oidc:11.6.6
```
