...
git clone --depth 1 --branch v11.5.7 https://github.com/mattermost/mattermost.git
...
cd mattermost
git apply ../mattermost-oidc/patches/mattermost-v11.5.7.patch
...
```bash
docker build -t your-registry/mattermost-oidc:11.5.7 .
docker push your-registry/mattermost-oidc:11.5.7
```
