...
git clone --depth 1 --branch v11.7.9 https://github.com/mattermost/mattermost.git
...
cd mattermost
git apply ../mattermost-oidc/patches/mattermost-v11.7.9.patch
...
```bash
docker build -t your-registry/mattermost-oidc:11.7.9 .
docker push your-registry/mattermost-oidc:11.7.9
```
