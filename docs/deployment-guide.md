...
git clone --depth 1 --branch v11.9.1 https://github.com/mattermost/mattermost.git
...
cd mattermost
git apply ../mattermost-oidc/patches/mattermost-v11.9.1.patch
...
```bash
docker build -t your-registry/mattermost-oidc:11.9.1 .
docker push your-registry/mattermost-oidc:11.9.1
```
